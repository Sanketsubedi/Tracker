...
<body>
    <div class="w-screen h-screen fixed">
        <div class="w-full h-full">
            ...
            include "nav.php";
            ?>
            <h1 class="flex justify-center text-indigo-500  sm:text-3xl text-2xl font-medium title-font mb-4  mt-5">Community Guidelines</h1>
            ...
            <div class="lg:w-2/5 md:w-1/2 md:pr-10 md:py-6">
                <div class="flex relative pb-12">
                    ...
                    <div class="flex-grow pl-4">
                        <h2 class="font-medium title-font text-sm text-gray-900 mb-1 tracking-wider">Respect and Consideration
                        </h2>
                        <p class="leading-relaxed">Treat others with kindness and thoughtfulness. Show respect and consideration in your interactions.</p>
                    </div>
                </div>
