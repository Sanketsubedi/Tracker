...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $query = "UPDATE `user` SET active_status = 'Active' WHERE active_token = '$token'";
                    ...
                    <div
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" method="POST">
                                ...
                                <button name="activation"
                                    class="w-full text-white bg-blue-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Activate</button>
                            </form>
                        </div>
                    </div>
                </div>
