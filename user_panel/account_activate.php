    ...
    try {
        ...
        if (isset($_POST['activate'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $query = "UPDATE `user` SET active_token = '$token' WHERE U_mail = '$email'";
                $result = mysqli_query($con, $query);
                ...
                $mail->Body = "Click the following link to activate your account: <a href='$resetLink'>$resetLink</a>";
                ...
                <script>
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
                        title: 'Activation email sent successfully.',
                            ...
                            <form class="space-y-4 md:space-y-6" method="POST">
                                <div>
                                    <label for="email"
                                        ...
                                        user account's verified email address and we will send you a activation
                                        link.</label>
